...
import "../styles/QdrantCollection.css"
...
const QdrantCollectionManager = () => {
  ...
  const fetchCollections = async () => {
    try {
      ...
      const collectionsWithDetails = await Promise.all(
        data.result.collections.map(async (collection) => {
          try {
            const detailResponse = await fetch(
              `${QDRANT_URL}/collections/${collection.name}`,
            )
            const detailData = await detailResponse.json()

            // Obtener número de puntos
            const countResponse = await fetch(
              `${QDRANT_URL}/collections/${collection.name}/points/count`,
            )
            ...
            console.error(
              `Error obteniendo detalles de ${collection.name}:`,
              error,
            )
            return {
              name: collection.name,
      ...
      setError(
        "Error conectando con Qdrant. Verifica que el servicio esté ejecutándose.",
      )
    } finally {
      setLoading(false)
    }
  ...
  const createCollection = async (collectionConfig) => {
    try {
      ...
      const response = await fetch(
        `${QDRANT_URL}/collections/${collectionConfig.name}`,
        {
          method: "PUT",
          headers: {
  ...
  const deleteCollection = async (collectionName) => {
    if (
      !window.confirm(
        `¿Estás seguro de que quieres eliminar la colección "${collectionName}"? Esta acción no se puede deshacer.`,
      )
    ) {
      return
    }
        ...
        <div className="loading-content">
          ...
          <div className="loading-text">
            ...
            <p className="loading-subtitle">
              Cargando colecciones vectoriales...
            </p>
            ...
            <div className="stat-content">
              ...
              <div>
                ...
                <p className="stat-value green">
                  {collections
                    .reduce((acc, col) => acc + (col.points_count || 0), 0)
                    .toLocaleString()}
                </p>
              </div>
            </div>
        ...
        <div className="collections-grid">
          {collections.map((collection) => (
            ...
            >
              {/* Gradiente de fondo */}
              <div
                className={`card-gradient ${getCollectionGradient(collection.name)}`}
              ></div>
                ...
                <div className="card-header">
                  <div className="card-info">
                    ...
                    <div>
                      ...
                      <span
                        className={`card-status ${getStatusClass(collection.status)}`}
                      >
                ...
                <div className="card-stats">
                  <div className="stat-row">
                    ...
                    <span className="stat-value-small">
                      {collection.points_count?.toLocaleString() || "0"}
                    </span>
                  </div>
                  <div className="stat-row">
                    <span className="stat-label">
          ...
          {collections.length === 0 && (
            <div className="empty-state">
              ...
              <h3 className="empty-title">
                🚀 ¡Comienza tu aventura vectorial!
              </h3>
              <p className="empty-description">
                No hay colecciones aún. Crea tu primera colección para comenzar
                a almacenar y buscar vectores de alta dimensión.
              </p>
              <button
                onClick={() => setShowCreateModal(true)}
            ...
            <div className="modal-header">
              <div className="modal-title-section">
                ...
                <p className="modal-subtitle">
                  Configura tu nueva colección vectorial
                </p>
              </div>
              <button
            ...
            <div className="modal-body">
              ...
              <div className="form-section">
                ...
                <div className="templates-grid">
                  {Object.entries(collectionTemplates).map(
                    ([key, template]) => (
                      <button
                        key={key}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewCollection((prev) => ({
                          ...prev,
                          vector_size: parseInt(e.target.value),
                        }))
                      }
                      className="form-input"
                      min="1"
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewCollection((prev) => ({
                              ...
                              hnsw_config: {
                                ...prev.hnsw_config,
                                ef_construct: parseInt(e.target.value),
                              },
                            }))
                          }
                          className="advanced-input"
          ...
          <div className="modal-content">
            <div className="modal-header">
              <div className="modal-title-section">
                ...
                <p className="modal-subtitle">
                  Configuración y estadísticas de la colección
                </p>
              </div>
              <button
            ...
            <div className="modal-body">
              <div className="details-grid">
                <div className="detail-card">
                  ...
                  <span
                    className={`card-status ${getStatusClass(selectedCollection.status)}`}
                  >
                ...
                <div className="detail-card">
                  ...
                  <span className="detail-value blue">
                    {selectedCollection.points_count?.toLocaleString()}
                  </span>
                </div>
                ...
                <div className="detail-card">
                  ...
                  <span className="detail-value green">
                    {selectedCollection.config?.params?.vectors?.size}
                  </span>
                </div>
                ...
                <div className="detail-card">
                  ...
                  <span className="detail-value purple">
                    {selectedCollection.config?.params?.vectors?.distance}
                  </span>
                </div>
              </div>
